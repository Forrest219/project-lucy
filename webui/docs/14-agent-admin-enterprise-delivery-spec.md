...
| 关联文档 | `docs/access-control/design-governance-baseline.md`、`docs/access-control/design-upgrade.md`、`docs/runbooks/agent-integration-guide.md`、`docs/runbooks/admin-guide.md`、`docs/governance/project-overview.md` |
