...
> 前置：M3 完成（fs-safe `ALLOW_FILES` 通道 + ktx CLI 封装 util）。详见 [`docs/design/design-schema-onboarding.md`](../../docs/design/design-schema-onboarding.md)。
...
- [x] T6.5 文档：`docs/webui/webui-module-guide.md` v1.3 / `docs/webui/webui-feature-map.md` §4 / `docs/webui/webui-impl-status.md` 同步
...
M6 依赖 M3 的 fs-safe `ALLOW_FILES` 通道与 ktx CLI 封装，详见 `docs/design/design-schema-onboarding.md`。
