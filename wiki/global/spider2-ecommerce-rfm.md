---
title: Spider2-lite E_commerce RFM
sl_refs:
  - connection: starrocks-r1
    sources:
      - s2_ecommerce_orders
      - s2_ecommerce_order_items
      - s2_ecommerce_order_payments
      - s2_ecommerce_customers
---

# Spider2-lite E_commerce RFM（Pilot）

来源：Spider2-lite `RFM.md`（MIT）。用于 Pilot 题 `local003` 等。
