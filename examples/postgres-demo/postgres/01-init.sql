CREATE SCHEMA IF NOT EXISTS dataforai AUTHORIZATION lucy;
...
CREATE TABLE IF NOT EXISTS dataforai.superstore_people (
...
CREATE TABLE IF NOT EXISTS dataforai.superstore_returns (
...
INSERT INTO dataforai.superstore_orders (
...
INSERT INTO dataforai.superstore_people (
...
INSERT INTO dataforai.superstore_returns (
  id, order_id, returned, source_system, source_file, source_sheet,
  source_row_number, batch_id, row_hash, is_deleted
) VALUES
  (1, 'D-1002', 'yes', 'demo', 'demo.xlsx', 'returns', 2, 'demo-20260621', 'demo-return-1', 0)
