...
| 当前状态源 | `docs/webui/webui-impl-status.md`, `docs/governance/project-overview.md`, `docs/specs/lucy-platform-goal-checklist.md` |

---

> **更新说明（2026-06-29）**：v1.0 是 2026-06-19 的缺口分析快照，当时 Admin、Eval、Audit 等模块尚未落地。v1.1 已按当前实现刷新，避免后续 agent 误把历史缺口当成当前缺口。模块级文件/API/测试清单仍以 `docs/webui/webui-impl-status.md` 为准。
...
| 给已有连接添加 schema | ✅ M6 已实现 | 在 webui 内给连接加 schema(database)，不接管新建连接 | `POST /api/connections/:connId/schemas`，详见 [`docs/design/design-schema-onboarding.md`](../design/design-schema-onboarding.md) |
...
| 主题 | 文档 |
|---|---|
| 当前模块实现状态 | `docs/webui/webui-impl-status.md` |
| 仓库级模块索引 | `docs/governance/project-overview.md` |
| 产品化验收合同 | `docs/specs/lucy-platform-goal-checklist.md` |
| WebUI 使用说明 | `docs/webui/webui-module-guide.md` |
