...
| 关联文档 | `docs/governance/DEVELOPMENT.md`、`docs/webui/webui-feature-map.md`、`docs/webui/webui-module-guide.md`、`webui/src/app/App.tsx`、`webui/docs/00-product-terminology-standard.md` |
...
- 不做视觉差异比对 / 视觉回归（这是另一条产品线，已有 `evals/golden/`）
- 不录视频、不录动画
...
| 版本 | 日期 | 变更 |
|---|---|---|
| v0.1 | 2026-08-02 | 初版：7 个核心设计决策收口，spec 落位 `docs/webui/webui-snapshot-product.md` |
