...
| 委托人 | zhangxingchen |
| 基于材料 | `webui/docs/01-architecture.md`(ADR-01~10)、`webui/docs/02-arch-spec.md`、`webui/docs/04-data-model.md`、`webui/docs/05-task-list.md`、`docs/design/design-db-connection.md`、`docs/webui/webui-feature-map.md`、`docs/webui/webui-module-guide.md`、`ktx.yaml.example` |
| 适用范围 | Builder 开发 WebUI schema onboarding 模块(代号 M6);Reviewer 核对 ADR-11 落地 |
| 输出位置 | /Users/forrest/Projects/project-lucy/docs/design/design-schema-onboarding.md |
...
| T6.5 | 文档:`docs/webui/webui-module-guide.md` v1.3 / `docs/webui/webui-feature-map.md` §4 / `docs/webui/webui-impl-status.md` 同步 | 与 spec 一致 |
