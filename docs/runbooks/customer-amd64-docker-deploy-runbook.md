...
> **配套文档**：[`docs/specs/lucy-customer-amd64-offline-delivery-spec.md`](../specs/lucy-customer-amd64-offline-delivery-spec.md)、[`docs/runbooks/customer-deployment-guide.md`](./customer-deployment-guide.md)、[`docs/runbooks/deployment-docker.md`](./deployment-docker.md)、[`docs/runbooks/security-guide.md`](./security-guide.md)。
...
- 见 [`docs/runbooks/security-guide.md`](./security-guide.md) §5（secrets / 5 do / 5 do-not）。
