...
| 事实源 | `docs/governance/vision.md`、`docs/specs/lucy-platform-goal-checklist.md`、`docs/governance/project-overview.md`、`docs/runbooks/security-guide.md`、`webui/docs/09-lucy-r1-mcp-tool-contract.md`、`webui/docs/62-trace-evidence-kernel-spec.md`、`webui/docs/08-mcp-audit-question-tracing-spec.md`、`webui/server/trace/evidence.ts`、`webui/server/proxy/mcp-proxy.ts`、`webui/src/pages/admin/Audit.tsx`、`docs/specs/lucy-202608-reliable-delivery-upgrade-spec.md`、`docs/access-control/gap-analysis-202608.md`（**注：2026-08-03 差距表已过时，P0 Trace 项多数已落地**）、`docs/webui/webui-feature-map.md` |
