...
| **POC Demo（MySQL）** | `deploy/compose/docker-compose.demo.yml` | `demo-db` | `examples/docker-demo/project-template/` | 5 分钟 Superstore 试用 |
| **POC Demo（Postgres）** | `deploy/compose/docker-compose.postgres-demo.yml` | `postgres-db` | `examples/postgres-demo/project-template/` | Postgres 驱动验证 |
| **Executive POC（内部）** | `deploy/compose/docker-compose.executive-poc.yml` | `demo-exec-db` | `examples/executive-poc/project-template/` | CFO/COO/CIO 能力演示 |
