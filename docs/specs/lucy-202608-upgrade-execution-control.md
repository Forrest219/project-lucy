...
| Source | `docs/specs/lucy-202608-reliable-delivery-upgrade-spec.md` v0.6 |
...
- For GOV-04, use `webui/docs/plans/wo-202608-04-safe-log-to-eval.md`；该工单**当前没有实现**，minimax 必须从零补齐 `server/eval/security-candidates.ts`、测试、`scripts/smoke/verify-202608-safe-log-to-security-eval.mjs` 与 `/api/eval/security-candidates*` 五个路由。
...
1. Read this file, the matching spec, the matching work order or umbrella plan task, `docs/governance/DEVELOPMENT.md`, and `webui/docs/00-product-terminology-standard.md`.
