...
| Execution control | `docs/specs/lucy-202608-upgrade-execution-control.md` |
| Gap analysis | `docs/access-control/gap-analysis-202608.md`（旧路径 `docs/specs/lucy-202608-access-governance-gap-analysis.md` 为跳转桩） |
