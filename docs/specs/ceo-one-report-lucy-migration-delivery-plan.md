...
| 资产 | 位置 | 用途 |
|---|---|---|
| R1 受控数据服务层计划 | `docs/specs/lucy-r1-controlled-data-service-plan.md` | 平台底座、MCP 契约、Policy、Guardrail、Eval 与可观测性总计划 |
...
| 数据问答 UAT 模板 | `docs/uat/uat-mysql-aliyun-data-qa.md` | 可复用 95% 准确率、审计、安全红线的 UAT 结构 |
