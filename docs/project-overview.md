...
| 可选 Agent Chat（A3，非默认交付；客户 bundle 无悬空入口） | `docs/design-lucy-agent-chat-a3.md`、`docs/runbook-lucy-agent-chat-a3.md`、`docker-compose.agent-chat.yml`、`agent-chat/`（仓库维护用；`smoke:p0:delivery-isolation` 保证 Lucy 镜像不含 A3） |
