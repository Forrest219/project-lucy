...
#
# Usage:
#   bash scripts/gates/k8s-acceptance.sh \
#     --namespace lucy-test \
#     --release lucy \
...
source "${ROOT}/scripts/gates/k8s-gate-lib.sh"
...
usage() {
  cat <<'EOF'
Usage: bash scripts/gates/k8s-acceptance.sh --namespace <ns> --release <name> [options]
