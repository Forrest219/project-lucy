...
export const A3_DOCKERIGNORE_PATTERNS = [
  "agent-chat",
  "deploy/compose/docker-compose.agent-chat.yml",
  "docs/design/design-lucy-agent-chat-a3.md",
  "docs/runbooks/runbook-lucy-agent-chat-a3.md",
  "scripts/smoke/agent-chat-a3-smoke.mjs",
  "scripts/smoke/agent-chat-a3-smoke.test.mjs"
];
...
export const A3_IMAGE_DENYLIST = [
  "/app/agent-chat",
  "/app/deploy/compose/docker-compose.agent-chat.yml",
  "/app/docs/design/design-lucy-agent-chat-a3.md",
  "/app/docs/runbooks/runbook-lucy-agent-chat-a3.md",
  "/app/scripts/smoke/agent-chat-a3-smoke.mjs",
  "/app/scripts/smoke/agent-chat-a3-smoke.test.mjs"
];
...
async function main() {
  ...
  if (args.help) {
    console.log(`Usage: node scripts/smoke/lucy-delivery-isolation-smoke.mjs [--check-images] [--image tag]... [--out path]
