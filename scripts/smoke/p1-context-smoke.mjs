...
const USAGE = `Usage:
  node scripts/smoke/p1-context-smoke.mjs [options]
...
const evidence = {
  ...
  generatedBy: "scripts/smoke/p1-context-smoke.mjs",
  projectRoot,
  status: "fail",
...
async function ktxRuntimeCheck() {
  if (!runKtx) {
    mark("ktxRuntime", "skipped", { reason: "not_requested", howToRun: "node scripts/smoke/p1-context-smoke.mjs --with-ktx" });
    return;
  }
  const ktxEnv = {
