...
if (values.help) {
  console.log(`Usage:
  node scripts/smoke/p1-publish-regression-smoke.mjs
  node scripts/smoke/p1-publish-regression-smoke.mjs --out inbox/p1-publish-regression-evidence.json
...
const evidence = {
  ...
  generatedBy: "scripts/smoke/p1-publish-regression-smoke.mjs",
  status: "passed",
  checks: [],
  blockers: []
};
