...
if (values.help) {
  console.log(`Usage:
  node scripts/smoke/p1-governance-smoke.mjs
  node scripts/smoke/p1-governance-smoke.mjs --url http://127.0.0.1:5174 --out inbox/p1-governance-evidence.json
...
const evidence = {
  ...
  generatedBy: "scripts/smoke/p1-governance-smoke.mjs",
  status: "passed",
  checks: [],
  blockers: []
};
