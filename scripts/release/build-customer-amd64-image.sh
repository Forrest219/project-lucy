...
# See docs/runbooks/customer-amd64-image-build-checklist.md
#
# Hard rules:
...
bash scripts/release/assert-image-elf-arch.sh "$IMAGE" amd64
...
bash scripts/gates/g8-image-k8s-contract-gate.sh "${IMAGE}"
...
echo "[build-customer-amd64] next: npm run gate:k8s-static + docker save + G7; see docs/runbooks/customer-amd64-image-build-checklist.md"
