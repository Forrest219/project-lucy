 ...
 *
 * Usage:
 *   LUCY_LICENSE_SIGNING_SECRET=<hex> node scripts/release/license-issue.mjs \
...
function usage() {
  console.error(`Usage: LUCY_LICENSE_SIGNING_SECRET=<secret> node scripts/release/license-issue.mjs \\
