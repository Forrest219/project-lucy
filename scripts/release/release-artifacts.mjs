...
function failUsage(message) {
  ...
  console.error("Usage: node scripts/release/release-artifacts.mjs [--out <dir>] [--tag <tag>] [--help|-h]");
  process.exit(2);
}
...
const REQUIRED_DOCS = [
  { src: "docs/governance/product-docs-index.md", dest: "lucy-product-docs-index.md" },
  { src: "docs/runbooks/admin-guide.md", dest: "lucy-admin-guide.md" },
  { src: "docs/runbooks/agent-integration-guide.md", dest: "lucy-agent-integration-guide.md" },
  { src: "docs/runbooks/security-guide.md", dest: "lucy-security-guide.md" },
  { src: "docs/runbooks/troubleshooting-guide.md", dest: "lucy-troubleshooting-guide.md" },
  { src: "docs/runbooks/customer-deployment-guide.md", dest: "lucy-customer-deployment-guide.md" },
  { src: "docs/runbooks/deployment-docker.md",          dest: "lucy-deployment-docker.md" },
  { src: "docs/governance/version-matrix.md",             dest: "lucy-version-matrix.md" },
  { src: "docs/governance/test-layers-and-release-gates.md", dest: "lucy-test-layers-and-release-gates.md" },
  { src: "docs/governance/lucy-test-cases.md",            dest: "lucy-test-cases.md" }
];
...
const SOURCE_BUNDLE_ENTRIES = [
  ...
  "Dockerfile",
  "docker-compose.yml",
  "deploy/compose/docker-compose.customer-config.yml",
  "deploy/compose/docker-compose.secrets.yml",
  "customer-config.example",
  "VERSION",
  "package.json",
  "package-lock.json",
  "scripts/smoke/headless-config-smoke.mjs",
  "scripts/smoke/lucy-delivery-isolation-smoke.mjs",
  "scripts/runtime/docker-entrypoint.sh",
  "scripts/runtime/docker-healthcheck.sh",
  "webui/package.json",
...
if (help) {
  console.log("Usage: node scripts/release/release-artifacts.mjs [--out <dir>] [--tag <tag>] [--help|-h]");
  console.log("");
...
function shouldCopySourceBundlePath(src) {
  ...
  if (parts.includes("smoke") && parts[0] !== "scripts") return false;
...
Use docs/runbooks/customer-deployment-guide.md, docs/runbooks/deployment-docker.md, and docs/runbooks/admin-guide.md for Docker Compose deployment and continuous configuration. The customer standard entry is Lucy MCP Proxy plus an Agent MCP client config; WebUI checks, when present, are repository quality gates and not the customer operating path.
Full P0/P1/P2 test case matrix: docs/governance/lucy-test-cases.md (bundled as release/lucy-test-cases.md).
...
- lucy-customer-deployment-guide.md (copy of docs/runbooks/customer-deployment-guide.md)
- lucy-deployment-docker.md (copy of docs/runbooks/deployment-docker.md)
- lucy-version-matrix.md (copy of docs/governance/version-matrix.md)
- lucy-test-layers-and-release-gates.md (copy of docs/governance/test-layers-and-release-gates.md)
- lucy-test-cases.md (copy of docs/governance/lucy-test-cases.md)
`;
