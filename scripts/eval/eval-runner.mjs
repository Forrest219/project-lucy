#!/usr/bin/env node
// scripts/eval/eval-runner.mjs — Project Lucy eval runner with pluggable Agent adapters
...
import { preflightAdapter, resolveAdapter } from './adapters/index.mjs';
...
const USAGE = `Usage: node scripts/eval/eval-runner.mjs [options]
