...
import { listAdapters, normalizeAdapterName, resolveAdapter } from "./adapters/index.mjs";

const RESULT_VERSION = 1;
const SUITE_VERSION = 1;
const SUITE_KIND = "lucy_eval_suite";

const USAGE = `Usage: node scripts/eval/lucy-eval-runner.mjs --suite <eval.yaml> --output <result.json> [options]
