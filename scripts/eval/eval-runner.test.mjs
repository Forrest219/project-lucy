#!/usr/bin/env node
// scripts/eval/eval-runner.test.mjs — minimal unit tests for T-A.3~T-A.6 helpers.
// Run with: node scripts/eval/eval-runner.test.mjs (no test framework; asserts via process.exit).
