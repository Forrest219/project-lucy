...
bash "${ROOT}/scripts/upgrade/upgrade-lucy.sh" -f deploy/compose/docker-compose.demo.yml "$@"
...
bash "${ROOT}/scripts/release/assert-image-elf-arch.sh" project-lucy:demo "${TARGETARCH}"
